...
# xxx2vec/binarize/binarize -input data/vocab.vec -output data/binary_vocab.vec \
#   -n-bits 256 -lr-rec 0.001 -lr-reg 0.001 -batch-size 75 -epoch 8
# xxx2vec/binarize/topk_binary data/binary_vocab.vec 20 trí_tuệ thực_hành hạnh_phúc


# xxx2vec/binarize/binarize -input data/wordvec.out -output data/binary_wordvec.out \
#   -n-bits 256 -lr-rec 0.001 -lr-reg 0.001 -batch-size 75 -epoch 8
